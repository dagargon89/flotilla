...
<head>
    ...
    <link rel="stylesheet" href="css/style.css">
    <link rel="stylesheet" href="[https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css](https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css)">
</head>
                ...
                <div class="card p-4 shadow-sm h-100">
                    ...
                    <div id="availability_list_container" style="display: none;">
                        <ul class="list-group mb-3" id="occupied_dates_list">
                            <!-- La lista de fechas ocupadas se cargará aquí -->
                        </ul>
